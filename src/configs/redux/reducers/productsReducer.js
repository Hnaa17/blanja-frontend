...
export const CreateproductsReducer = (state = initialState, { type, payload }) => {
    switch (type) {
  ...
  export const DeleteProductsReducer = (state = initialState, {type,payload}) => {
    switch (type) {
  ...
  export const UpdateProductsReducer = (state = initialState, { type, payload }) => {
    switch (type) {
